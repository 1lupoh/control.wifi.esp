...
const char* ssid = "tenta ae"; // ssid (nome da rede) wifi
...
void handleRoot() { // início código html
  server.send(200, "text/html",
              "<html>" \
                "<head><title>ESP8266 Demo</title> <script>  </script\></head>" \
                "<body>" \
                  ...
                  "<button value=\"ir?code=16771222\" id=\"botao\">flamengo</button>" \
                "</body>" \
              "</html>");
}
